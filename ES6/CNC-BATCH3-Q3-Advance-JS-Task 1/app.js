...
//   secondArg = array[Math.floor(array.length / 2)]
// ) => {
//   let finalArray = [];
//   array.filter(item => {
//     item != secondArg ? finalArray.push(item) : finalArray;
//   });
//   return finalArray;
// };
// console.log(skipSecondArg());
...
// console.log(athleteData.map(athlete => `Athlete ${athlete.athlete} in ${athlete.team} team earned ${athlete.income} euros`))
...
// // store the returned data in the variable given below the code should not exceed 4-5 lines
// const results = athleteData.filter((athlete) => athlete.income.toString().length > 7 ? athlete: "")
// console.log(results);
...
// athleteData.map(player => player.income > 10000000 ? console.log(`${player.athlete} is a great player.`) : false);
...
//     }
//   };
//   return obj1.secondArrow();
// };
// console.log(firstArrow("Arif", "Sanaullah"));
...
//     const PC = passedCourses[i];
//     for (let i = 0; i < arrayOfCourses.length; i++) {
//         const C = arrayOfCourses[i];
//         if (PC === C.id) {
//             console.log(`You've passed ${C.id} ${C.courseName}`);
//         }
//     }
// }
...
// const addUser = (name, Amt = 100) => {
//     data.push({ name: name, Amt: Amt })
// };
// addUser("Arif", 200)
// console.log(data);
...
//   let found;
//   for (let i = 0; i < data.length; i++) {
//      data[i].name === query || data[i].Amt == query ? found = data[i] : "";
//   }
//   return found;
// };
// console.log(findUser("300"));
